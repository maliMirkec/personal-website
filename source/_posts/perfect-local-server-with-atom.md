...
comments: true
thumbnail: https://res.cloudinary.com/starbist/image/upload/v1497509317/Perfect-local-server-with-Atom_xplcj6.png
...
{% cloudinary https://res.cloudinary.com/starbist/image/upload/v1497509507/bitnami-wamp-installation_p0sgui.gif false "Bitnami WAMP installation example." %}
...
{% cloudinary https://res.cloudinary.com/starbist/image/upload/v1497509503/php-server-settings_htpxrt.png 320px=f_auto,q_auto,w_270;720px=f_auto,q_auto,w_720;1440px=f_auto,q_auto,w_1440 "PHP-server settings." %}
...
{% cloudinary https://res.cloudinary.com/starbist/image/upload/v1497509505/livereload-settings_u6h4bx.png 320px=f_auto,q_auto,w_270;720px=f_auto,q_auto,w_720;1440px=f_auto,q_auto,w_1440 "Livereload settings." %}
