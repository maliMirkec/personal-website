...
{% cloudinary //res.cloudinary.com/starbist/image/upload/v1524385137/config-json-css_ha2n75.png 320px=f_auto,q_auto,w_320;640px=f_auto,q_auto,w_640 "config.json file, CSS part" %}
