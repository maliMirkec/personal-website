...
categories:
  - Blog
comments: true
thumbnail: http://res.cloudinary.com/starbist/image/upload/v1521878764/starter-project_vr5fq4.png
---
...
{% cloudinary //res.cloudinary.com/starbist/image/upload/v1497509218/code_g0esoz.png 320px=f_auto,q_auto,w_320;640px=f_auto,q_auto,w_640 "package.json file" %}
...
{% cloudinary //res.cloudinary.com/starbist/image/upload/v1497509218/code2_mxkqcq.png 320px=f_auto,q_auto,w_320;640px=f_auto,q_auto,w_640 "penthouse config" %}
