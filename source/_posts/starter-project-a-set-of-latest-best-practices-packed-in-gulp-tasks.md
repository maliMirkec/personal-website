...
{% cloudinary //res.cloudinary.com/starbist/image/upload/v1497509218/code_g0esoz.png 320px=f_auto,q_auto,w_270;720px=f_auto,q_auto,w_720 "package.json file." %}
...
{% cloudinary //res.cloudinary.com/starbist/image/upload/v1497509218/code2_mxkqcq.png 320px=f_auto,q_auto,w_270;720px=f_auto,q_auto,w_720 "Penthouse plugin config example." %}
