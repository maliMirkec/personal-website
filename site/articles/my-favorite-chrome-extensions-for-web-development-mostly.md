...
{% cldnryimg "Octotree_lq3wa7" "Octotree screenshot." 759 476 'center' %}
...
{% cldnryimg "Wappalizer_mn78hc" "Wappalizer screenshot." 759 402 'center' %}
...
{% cldnryimg "CSS_Feature_Toggles_d9qdzj" "CSS Feature Toggles screenshot." 759 431 'center' %}
...
{% cldnryimg "Workona_eurplk" "Workona screenshot." 759 385 'center' %}
...
{% cldnryimg "LastPass_tev0ul" "LassPass screenshot." 440 417 'center' %}
...
{% cldnryimg "Code_Line_Daily_v3ehh0" "Code Line Daily screenshot." 759 528 'center' %}
