...
{% cldnry "sync-settings-1_fdwmpf" "Sync-settings installation." 840 437 %}
...
{% cldnry "sync-settings-2_ojflpu" "Sync-settings configuration." 840 432 %}
...
{% cldnry "sync-settings-3_pzezsi" "Sync-settings in action." 840 401 %}
