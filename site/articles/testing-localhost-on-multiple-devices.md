...
{% cldnryfetch "Screen_Shot_2023-03-16_at_11.33.00_AM_oa478x" "macOS Screenshot of an output of a ifconfig command showing external IP address of a localhost." %}
...
{% cldnryfetch "Screen_Shot_2023-03-16_at_11.37.55_AM_qeptwn" "Windows 10 Screenshot of an output of a ifconfig command showing external IP address of a localhost." %}
...
{% cldnryfetch "wes-bos-tweet_evrsri" "Screnshot of Wes Bos' tweet showing how to use cloudflared." false true "center" %}
...
{% cldnryfetch "Screen_Shot_2023-03-16_at_12.44.36_PM_pasyp1" "Screenshot of Local app showing Live Links feature." %}
