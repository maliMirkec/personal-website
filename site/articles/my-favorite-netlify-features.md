...
{% cldnryfetch "netlify-dashboard-site-name_zqyqmg" "Netlify dashboard settings for custom site name" %}
...
{% cldnryfetch "netlify-dashboard-dns-records_jjg1tf" "Netlify DNS dashboard showing subdomains" %}
...
{% cldnryfetch "netlify-dashboard-subdomains_zeq1df" "Netlify DNS dashboard branch subdomains" %}
...
{% cldnryfetch "netlify-dashboard-inject-snippet_ruimjq" "Netlify snippet injection" %}
...
{% cldnryfetch "netlify-dashboard-split-testing_grzmlr" "Netlify dashboard for split testing" %}
...
{% cldnryfetch "netlify-dashboard-deploy-notifications_hcmabx" "Netlify dashboard for notification section." %}
...
{% cldnryfetch "netlify-notification-gmail_dyim14" "Netlify notifications in Gmail" %}
